...
<form action="/action_page.php">
  ...
  <div class="container">
    ...
    pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title=" Enter Email addrress characters@characters.domain" required>

    <label for="psw"><b>Password</b></label>
    <input type="password" placeholder="Enter Password" name="psw" 
    pattern=".{6,}" title="Six or more characters" required>
        
    <button type="submit" pattern="https?://.+" title="Include http://">Login</button>
    <label>
